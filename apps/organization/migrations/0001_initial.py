    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', DjangoUeditor.models.UEditorField(blank=True, null=True, verbose_name='机构描述')),
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='organization.CityDict')),
            ],
            options={
                'verbose_name': '课程机构',
